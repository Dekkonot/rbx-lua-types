...
local vec0 = DOM.Vector3int16.new(1, 2, 3)
...
assert(Util.typeof(vec0) == "Vector3int16", "vec0 was not a Vector3int16")
assert(Util.typeof(vec1) == "Vector3int16", "vec1 was not a Vector3int16")
assert(Util.typeof(vec2) == "Vector3int16", "vec2 was not a Vector3int16")
